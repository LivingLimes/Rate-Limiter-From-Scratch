...
public class FixedWindowCounterRateLimiterMiddlewareTests
{
    [Fact]
    public async Task FixedWindowCounterRateLimiterMiddleware_WhenRateLimitExceeded_Returns429ResponseCode()
    {
        var requestLimit = 1;
            ...
            .WithWebHostBuilder(builder =>
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                {
                    opts.Algorithm = "FixedWindowCounter";

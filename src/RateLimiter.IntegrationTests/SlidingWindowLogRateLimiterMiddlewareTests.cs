...
public class SlidingWindowLogRateLimiterMiddlewareTests
{
    [Fact]
    public async Task SlidingWindowLogRateLimiterMiddleware_WhenRateLimitExceeded_Returns429ResponseCode()
    {
        var requestLimit = 1;
            ...
            .WithWebHostBuilder(builder =>
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                {
                    opts.Algorithm = "SlidingWindowLog";
